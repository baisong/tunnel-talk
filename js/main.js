...
var KWM = {
	data: {
		...
		ethnicities: [
			{name: 'so', words: ['somali*~!', 'somalia~!', 'somalian!'], places: ['somalia', 'mogadishu']},
			{name: 'sl', words: ['somaliland!'], places: ['somaliland!']},
			...
			{name: 'sy', words: ['syria~!', 'syrian~!', 'aleppo?'], places: ['syria', 'aleppo']},
			...
			{name: 'bu', words: ['burma~', 'myanmar~', 'burmese*~!']},
			{name: 'kn', words: ['karen*!', 'thai*~!', 'thailand~'], places: ['burma', 'myanmar', 'thailand', 'kayin state']},
			{name: 'fg', words: ['afghanistan~!', 'afghan~!', 'afghani~!'], places: ['afghanistan']},
			{name: 'iq', words: ['iraq~', 'iraqi~!'], places: ['iraq']},
			{name: 'ch', words: ['chaldean!', 'chaldean-iraqi~', 'iraqi-chaldean']},
			{name: 'ic', words: ['christian iraqi', 'iraqi christian']},
			{name: 'co', words: ['congo', 'congolese!', 'drc'], places: ['congo', 'the congo', 'drc']},
			{name: 'su', words: ['sudan~', 'sudanese~!'], places: ['south sudan']},
			{name: 'ss', words: ['south sudan~', 'south sudanese~!'], places: ['sudan']},
			{name: 'ba', words: ['bantu*', 'somali bantu*']},
			{name: 'ea', words: ['east african', 'east africa'], places: ['east africa', 'eastern africa', 'horn of africa', 'the horn of africa']},
			{name: 'et', words: ['ethiopia~!', 'ethiopian*~!'], places: ['ethiopia']},
			{name: 'dj', words: ['djibouti~!', 'djiboutian~!'], places: ['djibouti']},
			{name: 'bh', words: ['bhutan~', 'bhutanese~'], places: ['bhutan']},
			{name: 'hm', words: ['hmong*~']},
			{name: 'ir', words: ['iran~', 'iranian~!'], places: ['iran']},
			{name: 'er', words: ['eritrea~', 'eritrean*~!'], places: ['eritrea']},
			{name: 'am', words: ['amharic*', 'oromo*']},
			{name: 'uz', words: ['uzbeki*~!', 'uzbek~!'], places: ['uzbekistan']},
			{name: 'gl', words: ['global?', 'international?', 'world?'], places: ['top countries']},
			{name: 'cr', words: ['crisis?', 'humanitarian?']},
			{name: 'as', words: ['asylum?', 'asylee?']},
			{name: 'ak', words: ['asylum-seeker?', 'asylum seeker?', 'asylum seeking?']},
			{name: 'ma', words: ['marginalized?', 'excluded?', 'scapegoated?']},
			{name: 'in', words: ['intersectional?', 'feminist?', 'progressive?']},
			{name: 'is', words: ['islamophobia?', 'anti islamophobia?', 'anti-islamophobia?']},
			{name: 'xe', words: ['xenophobia?', 'anti xenophobia?', 'anti-xenophobia?']},
			{name: 'rw', words: ['refugeeswelcome?', 'refugees welcome?', 'welcome refugees?']},
			{name: 'an', words: ['anti-trump?', 'anti trump?', 'fight trump?']},
			{name: 're', words: ['resist?', 'resistance?', 'indivisible?']},
			{name: 'iv', words: ['integrated voter engagement?', 'ive?']},
			{name: 'bl', words: ['black lives matter?', 'blacklivesmatter?']},
			{name: 'n1', words: ['no ban?', 'no ban no wall?', 'no ban no wall no raids?']},
		...
		term_groups: {
			...
			action: ['action', 'activist', 'activists', 'activism', 'voting', 'voter', 'voters', 'voting rights', 'voter outreach', 'expert', 'experts', 'professional', 'professionals', 'cultural competency', 'movement', 'justice', 'social justice', 'freedom', 'business', 'businesses', 'business owner', 'business owners', 'home owners', 'home ownership', 'civic engagement', 'empowerment', 'voice', 'voices', 'petition', 'sign-on'],
